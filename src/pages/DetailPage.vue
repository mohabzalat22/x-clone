            ...
            <div class="bg-gray-100 p-8 rounded-lg border shadow">
                <div class="flex my-6">
                    <div class="flex-shrink-0">
                        <img src="/src/assets/images/Image.png" alt="" class="w-12 h-12 rounded-full">
                    </div>
                    <div class="flex-grow px-4">
                        <div>
                            <h3 class="text-gray-800 font-bold text-xl">Alex Stanton</h3>
                        </div>
                        <div class="flex justify-between">
                            <h4 class="text-gray-400 text-sm">CEO at Bukalapak</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-between items-end">
                    ...
                    <div class="my-2">
                        <button class="bg-blue-500 text-white text-lg rounded-md py-2 px-4">Save</button>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="bg-white p-4 rounded-xl">
                            <div class="flex justify-between">
                                <div class="flex">
                                    ...
                                    <div class="ms-4 bg-blue px-4 py-1 bg-blue-500 text-white rounded">13</div>
                                </div>
                                <button class="bg-blue px-4 py-1 bg-blue-500 text-white rounded-lg">
                                    Add Review
                                </button>
                            </div>
                            <!-- persons -->
