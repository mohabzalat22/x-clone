<div class="d-flex w-100 g-0 mb-0 position-sticky top-0 backdrop-filter z-index-1090">
    <div class="flex-grow-1 g-0">
        <a class="btn border-0 w-100 fw-bold rounded-0 pb-0 button-x">
            <div class="m-0 d-inline-block">
                <div class="h6 py-2">For you</div>
                <div class="border-x invisible"></div>
            </div>
        </a>
    </div>
    <div class="flex-grow-1 g-0">
        <a class="btn border-0 w-100 fw-bold rounded-0 pb-0 button-x">
            <div class="m-0 d-inline-block">
                <div class="h6 py-2">Following</div>
